...
class DualVerifyView(tk.Toplevel):
    def __init__(self, master, controller):
        ...
        # Submit button
        self.jss_submit_btn = tk.Button(content_frame, text='Keep JSS Data', command=self.jss_submit_btn_clicked)
        self.jss_submit_btn.grid(row=6, column=3)
        # <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
